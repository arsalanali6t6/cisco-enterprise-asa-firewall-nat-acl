...
Full configuration and step-by-step explanation is in [`Enterprise_ASA_Firewall_Project_Report.docx`](IS Final Project Enterprise ASA Firewall Report ARSALAN ALI 70279).
